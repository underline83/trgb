...
**Aggiornamento 2026-07-19:** aggiunta la **154** (seed menu Estate 2026). Flaggate: **047, 097, 099, 100, 144, 154**.
...
| 154 | `154_seed_menu_estate_2026.py` | Seed menu Estate 2026 (PDF lug-ago-set): crea 20 ricette skeleton nuove (di cui 5 dolci), archivia Primavera 2026, crea edizione "Estate 2026" `in_carta` con 44 publications (36 da recipe incl. 5 sezione 'dolci' + 8 documentali) + 2 degustazioni (9 step). | Menu pubblicato specifico di Tre Gobbi (piatti, prezzi, degustazioni reali dell'osteria). | Modulo Menu Carta parte VUOTO, come per la 100. La sezione 'dolci' (introdotta [core] nello stesso rilascio nel router/FE) resta disponibile per tutti i locali. |
