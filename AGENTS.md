# TRGB Gestionale — Istruzioni per Codex
...
Da R1 in poi (anche se R1 non è ancora pushato), per OGNI feature/fix nuovo Codex DEVE classificare il lavoro in una di queste 3 categorie e scriverlo nel commit message:
...
Se Codex non sa rispondere alla domanda "questa feature dove va?", DEVE chiedere a Marco prima di scrivere codice. Vietato decidere da soli.
...
Se Codex non sa rispondere a "questa feature dove va?", deve CHIEDERE a Marco. Vietato decidere da soli.
