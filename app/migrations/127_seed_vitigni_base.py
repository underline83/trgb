...
# Seed: ~60 vitigni più diffusi. (nome, note).
# Nazione_origine rimossa 2026-05-13: i vitigni vivono in più nazioni, il
# campo è fuorviante. L'info storica è già dentro `note`.
SEED_VITIGNI = [
    # === ITALIANI BIANCHI ===
    ...
    ("Pinot Grigio",         "Variante italiana del Pinot Gris"),
    ...
    ("Pinot Nero",           "Equivalente italiano del Pinot Noir francese"),
    ...
    ("Gewürztraminer",       "Alsazia, Alto Adige, Germania"),
    ...
    ("Grenache",             "Francia (Rhône meridionale, Châteauneuf-du-Pape). Stesso del Cannonau italiano"),
...
def upgrade(conn: sqlite3.Connection) -> None:
    ...
    try:
        ...
        # Nota: la colonna nazione_origine è stata rimossa 2026-05-13 (fuorviante per vitigni
        # multi-nazione). L'info storica della nazione è dentro `note`.
        cur.executemany(
            "INSERT OR IGNORE INTO vini_vitigni_v2 (nome, note) VALUES (?, ?)",
            SEED_VITIGNI,
        )
