...
- **Lista ingredienti** `RicetteIngredienti.jsx` riscritta v3.0: testa arancio coerente con la scheda, 4 card KPI cliccabili come filtro rapido (`quickFilter` single-select), toolbar con ricerca estesa (nome/categoria/fornitore), ordinamento per nome/categoria/prezzo, «azzera filtri».
