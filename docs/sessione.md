...
### Sospeso
- **Mig 164, seed traduzioni Tre Gobbi `[locale:tregobbi]`**: manca `contenuti.py` (i dizionari EN/FR/ES). Il motore è deployabile e utile da solo: senza traduzioni a DB la pagina mostra italiano in tutte le lingue, esattamente come oggi. R5 è in stato utile (`locali/tregobbi/seeds/` esiste), quindi i testi andranno lì.
