# TRGB — Sessioni: archivio fino alla 59 (marzo–aprile 2026)

> ⚠️ **Archivio storico** — sessioni dalla ~39 alla 59 cont. e (fino al 2026-04-28), spostate da `sessione.md` il 2026-07-24.
> In coda ci sono anche le vecchie mappe di riferimento (file, DB, deploy) dell'epoca pre-refactor: **contenuto superato**, oggi le fonti sono `index.md`, `database.md`, `deploy.md`.
> I link relativi in questo file erano scritti per la cartella `docs/` e da qui possono non risolvere.
> Archivio precedente (sessioni ≤39): [sessione_archivio_39.md](sessione_archivio_39.md).
...
**Storico mini-sessioni dettagliato:** [`docs/archive/sessione_archivio_39.md`](./archive/sessione_archivio_39.md)
