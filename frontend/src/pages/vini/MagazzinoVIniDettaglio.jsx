...
// @version: v1.2-dettaglio-movimenti-locazioni
// Pagina Dettaglio Vino Magazzino — scheda + movimenti (con locazioni)
  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6 font-sans">
      <div className="max-w-6xl mx-auto bg-white shadow-2xl rounded-3xl p-8 lg:p-10 border border-neutral-200">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-neutral-600">
              Scheda vino + movimenti (aggiornano le giacenze per locazione).
            </p>
          </div>
        ...
        {loading && (
          <div className="mb-4 text-sm text-neutral-600 bg-neutral-50 border border-neutral-200 rounded-xl p-3">
            Caricamento…
          </div>
        )}
        ...
        {vino && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <MovimentiTab vinoId={vinoId} onAfterSave={fetchVino} />
            </div>
          </div>
        )}
      </div>
